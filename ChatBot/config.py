...
class Config:
    ...
    model_ckpt  = 'checkpoints/chatbot_0509_1437' # the path of the check point
    '''
    训练超参数
    '''
    batch_size = 2048
    shuffle = True                    # whether to shuffle the order of the dataloader
    num_workers = 0                   # number of process for the dataloader
