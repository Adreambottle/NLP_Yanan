...
class EncoderRNN(nn.Module):
    def __init__(self, Config, voc_length):
        '''
        Config: The configuration class defined in the config.py
        ...
        self.embedding = nn.Embedding(voc_length, Config.embedding_dim)
        
        self.gru = nn.GRU(Config.embedding_dim, self.hidden_size, self.num_layers,
