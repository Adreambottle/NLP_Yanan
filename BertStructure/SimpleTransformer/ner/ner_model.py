...
from MyTransformer.optimization import (
...
from MyTransformer.optimization import AdamW, Adafactor

from MyTransformer.models.albert import AlbertConfig, AlbertForTokenClassification, AlbertTokenizer
from MyTransformer.models.bert import BertConfig, BertForTokenClassification, BertTokenizer
from MyTransformer.models.roberta import RobertaConfig, RobertaForTokenClassification, RobertaTokenizer
...
from ner.ner_utils import InputExample,convert_examples_to_features
                            

from ner.DNN2GP import (compute_dnn2gp_quantities,
                        compute_laplace,
...
class NERModel:
    ...
    def predict(self, to_predict, split_on_space=True, prior_prec=1, gp_batch_size=2, candidate_num=5, var_num=5):
        """
